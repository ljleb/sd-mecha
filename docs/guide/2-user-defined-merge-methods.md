...
Without registering the config, since the model config registry will not be aware of the custom config, it will not be possible to infer the custom config automatically.
